...
function createFn() {
  ...
  graphics = game.add.graphics(
    mouseObject.position.x - 10,
    mouseObject.position.y - 10,
  );
...
function updateFn() {
  game.debug.text(
    'Level Editor v.1 controls: click: create hold   backspace: undo',
    20,
    20,
  );
  game.debug.text(
    ' up: increase diameter   down: decrease diameter   enter: log level data to console',
    20,
    40,
  );
